...
train_data = pd.read_csv("C:/Users/User/Desktop/infa materialy/SEM 6/BIAI/BIAI-Neural-Networks-Project/data/train.csv") #loading the data
test_data = pd.read_csv("C:/Users/User/Desktop/infa materialy/SEM 6/BIAI/BIAI-Neural-Networks-Project/data/test.csv")  #('../data/test.csv')
