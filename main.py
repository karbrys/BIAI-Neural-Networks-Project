...
train_data.drop(columns=['PassengerId', 'Name', 'SibSp', 'Parch', 'Ticket', 'Fare', 'Cabin', 'Embarked'], inplace=True)
test_data.drop(columns=['PassengerId', 'Name', 'SibSp', 'Parch', 'Ticket', 'Fare', 'Cabin', 'Embarked'], inplace=True)
...
# Age column mean
print("Age column mean in training data: ", train_data.Age.mean())
print("Age column mean in test data: ", test_data.Age.mean())
